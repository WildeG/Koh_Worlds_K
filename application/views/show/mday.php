<center>
	<div>
		...
		<a id="1c" href="<?php echo URL::base(); ?>show/menu_day?category=1" class="mday_inscriptions_min">I Категория</a><big class="mday_inscriptions_min">|</big>
		<a id="2c" href="<?php echo URL::base(); ?>show/menu_day?category=2" class="mday_inscriptions_min">II Категория</a><big class="mday_inscriptions_min">|</big>
		<a id="3c" href="<?php echo URL::base(); ?>show/menu_day?category=3" class="mday_inscriptions_min">III Категория</a>
		<div>
			<div class="mday_block">
				<a href=<?php echo '"'.URL::base().'show/recipe?id='.$mday[0]['id_recipe'].'"'; ?> class="mday_link">
				...
				<a href=<?php echo '"'.URL::base().'show/recipe?id='.$mday[2]['id_recipe'].'"'; ?> class="mday_link">
					<div class="mday_mblock">
