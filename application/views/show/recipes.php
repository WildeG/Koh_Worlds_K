		...
		<div class="show_mblock">
			...
			<div class="show_text">
				...
				<div class="show_basement">
					<div class="show_icon">
						<img class="mini_icon" title="Количество приготовивших" src=<?php echo '"'.URL::base().'public/image/system/prepared_icon.png"' ?>>&nbsp13 <!-- Колличество приготовивших -->
					</div>
					<div class="show_icon">
						<img class="mini_icon" title="Количество лайков" src=<?php echo '"'.URL::base().'public/image/system/likes_icon.png"' ?>>&nbsp13 <!-- Колличество лайков -->
					</div>
					<div class="show_icon">
						<img class="mini_icon" title="Количество порций" src=<?php echo '"'.URL::base().'public/image/system/servings_icon.png"' ?>>&nbsp13 <!-- Колличество порций -->
					</div>
					<div class="show_icon">
